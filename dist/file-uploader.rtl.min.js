 ...
 * LICENSE file in the root directory of this source tree.
 */
let k,z;e([s(`${w}-file-uploader`)],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[x({attribute:"helper-text"})],key:"helperText",value:()=>""},{kind:"field",decorators:[x({attribute:"label-text"})],key:"labelText",value:()=>""},{kind:"method",key:"render",value:function(){const{helperText:t,labelText:e}=this;return o(y||(y=u` <strong class="${0}--file--label"><slot name="label-text">${0}</slot></strong> <p class="${0}--label-description"> <slot name="helperText-text">${0}</slot> </p> <slot name="drop-container"></slot> <div class="${0}--file-container"> <slot></slot> </div> `),w,e,w,t,w)}},{kind:"field",static:!0,key:"styles",value:()=>f}]}}),n),function(t){t.UPLOADING="uploading",t.UPLOADED="uploaded",t.EDITING="editing"}(k||(k={})),function(t){t.REGULAR="",t.SMALL="sm",t.FIELD="field"}(z||(z={}));let q,$,j,C=t=>t;const{prefix:D}=i;e([s(`${D}-file-uploader-item`)],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"method",key:"_handleClickDeleteButton",value:function(){const t={bubbles:!0,cancelable:!0,composed:!0},{eventBeforeDelete:e,eventDelete:o}=this.constructor;this.dispatchEvent(new CustomEvent(e,t))&&this.dispatchEvent(new CustomEvent(o,t))}},{kind:"method",key:"_renderEditing",value:function(){const{deleteAssistiveText:t,invalid:e,_handleClickDeleteButton:i}=this;return o(q||(q=C` ${0} <button type="button" aria-label="${0}" class="${0}--file-close" @click="${0}"> ${0} </button> `),e?d({class:`${D}--file-invalid`}):void 0,t,D,i,g())}},{kind:"method",key:"_renderUploading",value:function(){const{uploadingAssistiveText:t}=this;return o($||($=C` <bx-loading assistive-text="${0}" type="${0}"></bx-loading> `),t,p.SMALL)}},{kind:"method",key:"_renderUploaded",value:function(){const{uploadedAssistiveText:t}=this;return c({class:`${D}--file-complete`,"aria-label":t})}},{kind:"method",key:"_renderStatus",value:function(){const{state:t}=this;switch(t){case k.EDITING:return this._renderEditing();case k.UPLOADING:return this._renderUploading();case k.UPLOADED:return this._renderUploaded();default:return}}},{kind:"field",decorators:[x({attribute:"delete-assistive-text"})],key:"deleteAssistiveText",value:()=>"Delete this file"},{kind:"field",decorators:[x({type:Boolean,reflect:!0})],key:"invalid",value:()=>!1},{kind:"field",decorators:[x({reflect:!0})],key:"size",value:()=>z.REGULAR},{kind:"field",decorators:[x({reflect:!0})],key:"state",value:()=>k.UPLOADING},{kind:"field",decorators:[x({attribute:"uploading-assistive-text"})],key:"uploadingAssistiveText",value:()=>"Uploading"},{kind:"field",decorators:[x({attribute:"uploaded-assistive-text"})],key:"uploadedAssistiveText",value:()=>"Uploaded"},{kind:"field",decorators:[x({attribute:"validity-message"})],key:"validityMessage",value:()=>""},{kind:"method",key:"render",value:function(){const{validityMessage:t}=this;return o(j||(j=C` <p class="${0}--file-filename"><slot></slot></p> <span class="${0}--file__state-container">${0}</span> <div class="${0}--form-requirement"> <div class="${0}--form-requirement__title"> <slot name="validity-message">${0}</slot> </div> <p class="${0}--form-requirement__supplement"> <slot name="validity-message-supplement"></slot> </p> </div> `),D,D,this._renderStatus(),D,D,t,D)}},{kind:"get",static:!0,key:"eventBeforeDelete",value:function(){return`${D}-file-uploader-item-beingdeleted`}},{kind:"get",static:!0,key:"eventDelete",value:function(){return`${D}-file-uploader-item-deleted`}},{kind:"field",static:!0,key:"styles",value:()=>f}]}}),n);
