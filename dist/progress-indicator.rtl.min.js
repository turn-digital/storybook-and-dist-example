 ...
 * LICENSE file in the root directory of this source tree.
 */
let y;!function(t){t.QUEUED="queued",t.CURRENT="current",t.COMPLETE="complete",t.INVALID="invalid"}(y||(y={}));let u,w,k,z,Y,$=t=>t;const{prefix:X}=r,C={[y.QUEUED]:({children:t,attrs:o={}}={})=>b(u||(u=$`
      <svg ...="${0}">
        ${0}
        <path d="M8 1C4.1 1 1 4.1 1 8s3.1 7 7 7 7-3.1 7-7-3.1-7-7-7zm0 13c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6z" />
      </svg>
    `),p(o),t),[y.CURRENT]:({children:t,attrs:o={}}={})=>b(w||(w=$`
      <svg ...="${0}">
        ${0}
        <path d="M 7, 7 m -7, 0 a 7,7 0 1,0 14,0 a 7,7 0 1,0 -14,0" />
      </svg>
    `),p(o),t),[y.COMPLETE]:({children:t,...o}={})=>b`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${p(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 32 32">${t}${t}<path d="M14 21.414L9 16.413 10.413 15 14 18.586 21.585 11 23 12.415 14 21.414z"></path><path d="M16,2A14,14,0,1,0,30,16,14,14,0,0,0,16,2Zm0,26A12,12,0,1,1,28,16,12,12,0,0,1,16,28Z"></path></svg>`,[y.INVALID]:({children:t,...o}={})=>b`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${p(o)}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${t}${t}<path d="M8,1C4.1,1,1,4.1,1,8s3.1,7,7,7s7-3.1,7-7S11.9,1,8,1z M8,14c-3.3,0-6-2.7-6-6s2.7-6,6-6s6,2.7,6,6S11.3,14,8,14z"></path><path d="M7.5 4H8.5V9H7.5zM8 10.2c-.4 0-.8.3-.8.8s.3.8.8.8c.4 0 .8-.3.8-.8S8.4 10.2 8 10.2z"></path></svg>`};o([x(`${X}-progress-step`)],(function(t,o){class i extends o{constructor(...o){super(...o),t(this)}}return{F:i,d:[{kind:"field",decorators:[a({type:Boolean,reflect:!0})],key:"disabled",value:()=>!1},{kind:"field",decorators:[a({attribute:"icon-label"})],key:"iconLabel",value:void 0},{kind:"field",decorators:[a({attribute:"label-text"})],key:"labelText",value:void 0},{kind:"field",decorators:[a({attribute:"secondary-label-text"})],key:"secondaryLabelText",value:void 0},{kind:"field",decorators:[a()],key:"state",value:()=>y.QUEUED},{kind:"field",decorators:[a({type:Boolean,reflect:!0})],key:"vertical",value:()=>!1},{kind:"method",key:"createRenderRoot",value:function(){var t;return this.attachShadow({mode:"open",delegatesFocus:Number((null!==(t=/Safari\/(\d+)/.exec(navigator.userAgent))&&void 0!==t?t:["",0])[1])<=537})}},{kind:"method",key:"connectedCallback",value:function(){this.hasAttribute("role")||this.setAttribute("role","listitem"),n(l(i.prototype),"connectedCallback",this).call(this)}},{kind:"method",key:"updated",value:function(t){t.has("disabled")&&this.setAttribute("aria-disabled",String(Boolean(this.disabled)))}},{kind:"method",key:"render",value:function(){const{iconLabel:t,labelText:o,secondaryLabelText:i,state:r}=this;return e(k||(k=$` ${0} <slot> <p role="button" class="${0}--progress-label" tabindex="0" aria-describedby="label-tooltip"> ${0} </p> </slot> <slot name="secondary-label-text"> ${0} </slot> <span class="${0}--progress-line"></span> `),C[r]({class:{[y.INVALID]:`${X}--progress__warning`}[r],children:t?b(z||(z=$`<title>${0}</title>`),t):void 0}),X,o,i?e(Y||(Y=$` <p class="${0}--progress-optional">${0}</p> `),X,i):void 0,X)}},{kind:"field",static:!0,key:"styles",value:()=>_}]}}),g(i));let M,q=t=>t;const{prefix:A}=r;o([x(`${A}-progress-step-skeleton`)],(function(t,o){return{F:class extends o{constructor(...o){super(...o),t(this)}},d:[{kind:"field",decorators:[a({type:Boolean,reflect:!0})],key:"vertical",value:()=>!1},{kind:"method",key:"render",value:function(){return e(M||(M=q` <div class="${0}--progress-step-button ${0}--progress-step-button--unclickable"> <svg> <path d="M 7, 7 m -7, 0 a 7,7 0 1,0 14,0 a 7,7 0 1,0 -14,0"/> </svg> <p class="${0}--progress-label"></p> <span class="${0}--progress-line"></span> </div> `),A,A,A,A)}},{kind:"field",static:!0,key:"styles",value:()=>_}]}}),i);
